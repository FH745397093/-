...
namespace BSTool
{
    public class MySqlDB
    {
        ...
        public MySqlDB(string ConnAddStr) { getConn(ConnAddStr); }
         ...
         * 执行DML语句（可带参数）
         * */
        public int execSql(string sql, MySqlParameter[] para)
        {
            if (this.isTrans)
            {
                this.cmd = conn.CreateCommand();
            ...
            this.cmd.CommandText = sql;
            foreach (MySqlParameter parameter in para)
            {
         ...
         * */
        public int execSqlREF(string sql, MySqlParameter[] para)
        {
            int J = 0;
            if (this.isTrans)
            {
        ...
        * 通过SQL语句返回结果集
        * */
        public System.Data.DataSet getDataSet(string sql, MySqlParameter[] para)
        {
            DataSet dataSet = new DataSet();
            try
            {
         ...
         **/
        private MySqlCommand getSqlCmd(string sql, MySqlParameter[] para)
        {
